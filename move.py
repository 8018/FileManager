...
dsts = dict([('AI', '%sAI/' % photo_folder),
             ('JVID', '%sJVID/' % photo_folder),
             ('X-City', '%s日本/' % photo_folder),
             ('Others', '%sOthers/' % photo_folder),
             ...
             ('PURE MEDIA', '%sPureMedia/' % photo_folder),
             ('PURE_', '%sPureMedia/' % photo_folder),
             ('PureMedia', '%sPureMedia/' % photo_folder),
             ('Moonnight', '%sMoonnight/' % photo_folder),
             ('街拍', '%s街拍/' % photo_folder),
             ('尤果网', '%sUgirls/' % photo_folder),
             ('北京天使', '%s北京天使/' % photo_folder),
             ('彩画', '%s彩画/' % photo_folder),
             ('摄影', '%s摄影/' % photo_folder),
